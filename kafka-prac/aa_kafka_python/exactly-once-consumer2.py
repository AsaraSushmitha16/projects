...
import json
consumer=KafkaConsumer('hello_world',bootstrap_servers=['localhost:9092'],value_deserializer=lambda x:json.loads(x.decode('utf-8')),group_id='demos',auto_offset_reset='earliest',enable_auto_commit=False)
